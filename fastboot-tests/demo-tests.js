...
Qmodule('demo app', function (hooks) {
  ...
  test('first', async function (assert) {
    ...
    assert.ok(
      /This is the first page/.test(doc.body.textContent),
      'found text'
    );
  });
  ...
  test('second', async function (assert) {
    ...
    assert.ok(
      /This is the second page/.test(doc.body.textContent),
      'found text'
    );
  });
  ...
  test('third', async function (assert) {
    ...
    assert.ok(
      /This is the third page/.test(doc.body.textContent),
      'found text'
    );
  });
  ...
  test('four', async function (assert) {
    ...
    assert.ok(
      /This is the fourth page/.test(doc.body.textContent),
      'found text'
    );
  });
});
